...
import (
	...
	"k8s.io/gengo/args"
	clientgenargs "k8s.io/repo-infra/generate/cmd/libs/go2idl/client-gen/args"
	"k8s.io/repo-infra/generate/cmd/libs/go2idl/client-gen/generators"
	"k8s.io/repo-infra/generate/cmd/libs/go2idl/client-gen/types"
...
var (
	...
	inputVersions = flag.StringSlice("input", nil, "group/versions that client-gen will generate clients for. At most one version per group is allowed. Specified in the format \"group1/version1,group2/version2...\".")
	...
	basePath               = flag.String("input-base", "", "base path to look for the api group.")
	...
	clientsetPath          = flag.String("clientset-path", "", "the generated clientset will be output to <clientset-path>/<clientset-name>.")
...
func main() {
	...
	arguments.GoHeaderFilePath = filepath.Join(args.DefaultSourceTree(), "k8s.io/repo-infra/verify/boilerplate/boilerplate.go.txt")
	flag.Parse()
	var cmdArgs string
