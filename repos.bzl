...
def go_repositories():
    ...
    go_repository(
        ...
        sum = "h1:aJVl+xDmB1VkCrLev/VX9jah/wJX/I58lUclpeX5zBY=",
        version = "v0.0.0-20200302185339-bb8466fe872a",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:tirixpud1WdjE3/NrL9ar4ot0ADfwls8sOcIf1ivRDw=",
        version = "v0.0.0-20200207204624-4f3edf09f4f6",
    )
    go_repository(
